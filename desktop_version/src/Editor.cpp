...
void editorinput(void)
{
    ...
    else
    {
        ...
        else
        {
            ...
            {
                cl.setroomwarpdir(ed.levx, ed.levy, (cl.getroomprop(ed.levx, ed.levy)->warpdir+1)%4);
                if(cl.getroomprop(ed.levx, ed.levy)->warpdir==0)
                {
                    ed.note="Room warping disabled";
                    ed.notedelay=45;
                    graphics.backgrounddrawn=false;
                }
                else if(cl.getroomprop(ed.levx, ed.levy)->warpdir==1)
                {
                    ed.note="Room warps horizontally";
                    ed.notedelay=45;
                    graphics.backgrounddrawn=false;
                }
                else if(cl.getroomprop(ed.levx, ed.levy)->warpdir==2)
                {
                    ed.note="Room warps vertically";
                    ed.notedelay=45;
                    graphics.backgrounddrawn=false;
                }
                else if(cl.getroomprop(ed.levx, ed.levy)->warpdir==3)
                {
